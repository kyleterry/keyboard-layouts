...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_LGUI, KC_LALT, KC_LCTL, KC_SPC, MO(3), KC_SPC, KC_LGUI, MO(3), KC_NO, MO(2), KC_VOLD),
	...
	LAYOUT(
		...
		CTRL_ESC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,
		KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TD(TD_GO), KC_VOLU,
		KC_LGUI, KC_LALT, KC_LCTL, KC_SPC, TD(TD_OW), KC_SPC, KC_LGUI, MO(3), KC_NO, MO(2), KC_VOLD),
	...
	LAYOUT(
		...
		______, ______, ______, ______, ______, ______, TO(0), TO(1), ______, ______, ______, ______, ______,
